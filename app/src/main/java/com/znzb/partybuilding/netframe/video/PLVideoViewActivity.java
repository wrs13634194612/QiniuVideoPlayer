...
import com.znzb.partybuilding.netframe.video.MediaController.OnClickSpeedAdjustListener;
...
public class PLVideoViewActivity extends VideoPlayerBaseActivity {
    ...
    private int mDisplayAspectRatio = PLVideoView.ASPECT_RATIO_PAVED_PARENT; //设置视频比例
    ...
    private PLOnCompletionListener mOnCompletionListener = new PLOnCompletionListener() {
        ...
        public void onCompletion() {
            ...
            Utils.showToastTips(PLVideoViewActivity.this, "播放完成!");
            if (!mIsLiveStreaming) {
